...
<form action="" className='w-full'>
    <div className='flex flex-col md:flex-row  items-stretch gap-[14px] md:max-w-[610px] mx-auto'>
        <input type="text" placeholder='enter your work email' className='lg:min-h-[56px] min-h-[50px] px-4 rounded-lg bg-transparent border-white border-[1px] w-full placeholder:text-cadet-blue outline-0 font-source-sans lg:text-base text-sm' />
